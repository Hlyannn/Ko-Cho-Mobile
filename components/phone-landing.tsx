...
export default function PhoneLanding() {
  ...
  useEffect(() => {
    ...
    const phonePositions = {
      ...
      vision: { top: "50%", left: "25%", transform: "translate(-50%, -50%)" },
      goals: { top: "50%", left: "75%", transform: "translate(-50%, -50%)" },
      contact: { top: "50%", left: "75%", transform: "translate(-50%, -50%)" }
    }
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/70 backdrop-blur-lg shadow-lg border-b border-red-200">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-20">
            <div className="text-2xl font-extrabold tracking-wide text-red-600 drop-shadow-sm font-sans uppercase">Ko Cho Mobile Shop</div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow">
                    ...
                    <div className="flex gap-6">
                      <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-red-600 hover:text-red-800 transition-colors">
                      ...
                      <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-red-600 hover:text-red-800 transition-colors">
                      ...
                      <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="text-red-600 hover:text-red-800 transition-colors">
